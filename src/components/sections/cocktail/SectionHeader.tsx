...
export default function SectionHeader({
  ...
  return (
    <>
      ...
      <RoundedHoverButton className="mb-[66px] md:mb-[79px] inline-flex items-center justify-center px-6 py-3 border border-white/50 rounded-full uppercase text-sm tracking-wider hover:bg-white/10 transition-all">
        {buttonText}
      </RoundedHoverButton>
    </>
  );
